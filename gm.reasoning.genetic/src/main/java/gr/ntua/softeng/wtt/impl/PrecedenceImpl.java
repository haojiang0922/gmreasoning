 ...
 * <ul>
 *   <li>{@link gr.ntua.softeng.wtt.impl.PrecedenceImpl#getFrom <em>From</em>}</li>
 *   <li>{@link gr.ntua.softeng.wtt.impl.PrecedenceImpl#getTo <em>To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PrecedenceImpl extends TemplateLinkImpl implements Precedence {
	/**
	...
	protected EClass eStaticClass() {
		return WttPackage.Literals.PRECEDENCE;
	}
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WttPackage.PRECEDENCE__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(CompositeNode newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WttPackage.PRECEDENCE__FROM, oldFrom, from));
	}
	...
	public CompositeNode getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WttPackage.PRECEDENCE__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(CompositeNode newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WttPackage.PRECEDENCE__TO, oldTo, to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WttPackage.PRECEDENCE__FROM:
				if (resolve) return getFrom();
				return basicGetFrom();
			case WttPackage.PRECEDENCE__TO:
